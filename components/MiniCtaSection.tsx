...
const MiniCtaSection: React.FC = () => {
  return (
    <motion.section
      id="mini-cta" 
      className="py-16 md:py-24 px-4 text-white flex items-center justify-center min-h-[50vh] relative overflow-hidden" // min-h-[50vh] for half-page feel
    ...
    >
      ...
      <div className="container mx-auto max-w-3xl relative z-10 text-center">
        ...
        >
          Let's Create a Great Website for Your <span className="text-[#892CDC]">Business.</span>
        </motion.h2>
